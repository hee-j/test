...
/////////////// Set parameter /////////////////////////////
int BMX055::set_parameter(const BMX055_TypeDef *bmx055_parameter)
{
    bmx055_parameters = *bmx055_parameter;
    return set_parameters_to_regs();
...
int BMX055::set_parameters_to_regs(void)
{
    int res = 0;
    // ACC
    chip_addr = inf_addr.acc_addr;
    ...
    res = _i2c.write(chip_addr, dt, 2, false);
    wait_us(1000);
